...
# Defining the giver pose 
default_joint_3d_handover = constant.GIVER_HAND_POSE

fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')

x_data = default_joint_3d_handover[:, 0]
y_data = default_joint_3d_handover[:, 1]
z_data = default_joint_3d_handover[:, 2]

# Plot the joints
ax.scatter(x_data, y_data, z_data, c='r', marker='o')

# connect the joints with lines to visualize the hand
connections = [
